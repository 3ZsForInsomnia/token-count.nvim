...
local function model_picker(callback)
  ...
  callback = callback or function(technical_name, model_config)
  ...
  for _, model_entry in ipairs(searchable_models) do
    ...
    local ordinal = string.format("%s %s %s", 
      model_entry.nice_name, 
    ...
    previewer = previewers.new_buffer_previewer({
      ...
      define_preview = function(self, entry, status)
        ...
        local lines = {
          ...
          "",
          "Token Limits:",
          "  Input (Context): " .. formatting.format_number_with_commas(model.context_window) .. " tokens",
          "  Output (Max): " .. formatting.format_number_with_commas(model.max_output_tokens) .. " tokens",
          "",
